...
// 		</tr>
/// ```
fn parse_hearings_main_html_file(path:&Path,base_url:&str) -> anyhow::Result<Vec<CurrentBill>> {
...
pub async fn create_bills_list()  -> anyhow::Result<()> {
    ...
    let mut hearings: Vec<CurrentBill> = vec![];
